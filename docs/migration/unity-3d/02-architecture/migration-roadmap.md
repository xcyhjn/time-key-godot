...
| 02 战斗规则扩展 | 全卡牌效果、形状、敌人/建筑、胜负 | Wave 01 无架构阻断 | parity fixtures、战斗闭环 |
| 03 局外闭环 | 3D 局外地图、房间、奖励、返回 | 存档兼容策略已决策 | 固定 seed 流程、跨场景测试 |
| 04 内容与体验 | 教程、音频、VFX、中文字体、资产 | 授权清单完成 | 视觉/音频对照、性能预算 |
| 05 发布加固 | 存档升级、平台、构建与回归 | 目标平台冻结 | 发布构建、回归矩阵 |

Wave 00 与 Wave 01 已于 2026-07-31 关闭。Wave 02 的进入条件已满足技术部分，但在扩展敌方意图前仍需保留 MIG-002 所述的源行为，不把空 command 解析静默当成设计缺陷修复。
