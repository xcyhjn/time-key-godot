...
| --- | --- | --- | --- | --- |
| `TimeKey.Domain` | 坐标、卡牌 typed schema、时间轴、效果、战斗状态/快照 | handler、纯模型 | 无 | Unity、资源路径、UI、Application |
| `TimeKey.Application` | 选卡、typed target、预览、提交、取消、结算 phase | `CombatApplicationSession`、`ICardCatalog`、`ICombatTraceSink` | Domain | Unity、Infrastructure、View、Resources |
