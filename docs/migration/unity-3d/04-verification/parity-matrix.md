...
判定词只使用：`等价`、`允许差异`、`未实现`、`已知缺陷`、`待验证`。Slice 01、Wave 02A、Wave 02B1、Wave 02B2A、解耦 R1/R2/R3 与 Remaining Cards Gate A 已关闭。Tower decay、Poison tick 与敌方/建筑行动留给 02B3，牌库/回合资源/胜负留给 02B4，局外保持原状。
