...
Final verification is full EditMode `334/334`, CombatShell PlayMode `5/5`, full D3D12 PlayMode `69/69`, post-build assets `3/3`, Windows build `Succeeded` at `217436478` bytes and actual Bootstrap Player smoke exit 0. The final review added direct `Refresh(CombatSessionView)` coverage for the Application snapshot boundary. Evidence entry: `04-verification/evidence/combat-shell-gate-b/verification-summary.md`.
