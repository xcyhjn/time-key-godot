...
敌人协议检查
is_intent_preview_enabled()
can_generate_intent(hex_map)
get_intent_shape()
shape 缓存
```
...
is_placement_valid()
place_action()
find_random_available_spot()
TimelineAction.action_data 契约
TimelineUI 表现
敌方意图 tooltip
回合结算 resolve_timeline()
```

### 备选：EnemyIntentPresentationController 的 tooltip 表现
